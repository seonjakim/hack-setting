...
const funderAccountId = "nft_test_front.testnet";
...
async function createTrialAccount() {
  ...
  console.log(`
    ...
    Alpha:
 	...
 	Good Luck!
    `);
  return `${guestBookInstance}${keypomContractId}${delimiter}${secretKey}`;
}

exports.createTrialAccount = createTrialAccount;
